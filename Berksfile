...
cookbook 'openstack-block-storage', github: 'jjasghar/cookbook-openstack-block-storage', branch: "master"
cookbook 'openstack-common', github: 'jjasghar/cookbook-openstack-common', branch: "master"
...
cookbook 'openstack-ops-database', github: 'jjasghar/cookbook-openstack-ops-database', branch: "master"
